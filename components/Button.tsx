...
const Button = ({variant, text, onclick,  extraStyle, startIcon}: ButtonProps) => {
  return (
    <>
    <button  onClick={onclick} className={`${style[variant]} ${defaultStyle} ${extraStyle}`}>{startIcon}{text}</button>
    </>
  )
}
